...
if ( TRACE ) { TRACE( "AnswerManager#CheckforEndCard", this ); }
                ...
                if (this._iteration === 1 && this.quizzesDone >= 2) {
                    GameManager.Instance.OnCTAClicked();
                    GameManager.Instance.GameOverSequence();
                }
            },
